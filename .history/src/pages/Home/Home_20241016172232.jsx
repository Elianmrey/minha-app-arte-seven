...
export default function Home() {
    ...
    const dataSearchedMovies = searchResults.filter((item) => item.media_type === "movie");
    const dataSearchedTv = searchResults.filter((item) => item.media_type === "tv");
    ...
    return (
            ...
            <div className={StyleLayout.cardsContainer}>
                ...
                {
                    searchResults.length > 0 ? (<div className={StyleLayout.searchContainer}>
                        ...
                        <div className={StyleLayout.searchResultsContainer}>
                            <h2 className={StyleLayout.titleFilms}>Filmes</h2>
                            <Card info={dataSearchedTv} cardType="movies" />
                        </div>
                          </div>
                    ): (<div className = {StyleLayout.Container}>
