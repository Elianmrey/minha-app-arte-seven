...
export default function AvalModal({ avaliate, CloseModalOnButtonClicked })
{
    return (
        <div className={StyleModal.AvalContainer}>
            <div className={StyleModal.closeButtonContainer}>
                <svg onClick={CloseModalOnButtonClicked} className={StyleModal.closeButton} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
