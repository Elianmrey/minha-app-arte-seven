...
export default function Home() {
    ...
    let dataSearchedMovies = searchResults.filter((movie) => movie.media_type === "movie");
    let dataSearchedTv = searchResults.filter((tvProgram) => tvProgram.media_type === "tv");
    console.log(dataSearchedMovies)
    console.log(dataSearchedTv)
    return (
