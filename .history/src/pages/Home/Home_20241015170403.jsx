...
export default function Home() {
  ...
  async  function SearchGeralContent(term) {
     ...
     const response= await  GetCardInfo(`https://api.themoviedb.org/3/search/movie?query=${processedTerm}&include_adult=false&language=pt-BR&page=1`)
      setSearchTerm(response); 
        
    };
    const searchResult = await SearchGeralContent
