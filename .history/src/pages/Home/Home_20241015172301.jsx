...
export default function Home() {
    ...
    const SearchGeralContent = async (term) => {
        const searchResults =  GetCardInfo(`https://api.themoviedb.org/3/search/multi?query=${term}Gun&include_adult=false&language=en-US&page=1`)
        setSearchTerm(term); 
    };
