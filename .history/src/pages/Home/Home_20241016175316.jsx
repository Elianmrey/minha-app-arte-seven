...
export default function Home() {
   ...
   async function SearchGeralContent(term) {
        try {
            ...
            if (searchResponse)
            {
                setSearchMovieResults(await searchResponse.then(searchResponse.filter(movie => movie.media_type === "movie")));
                setSearchTvResult(await searchResponse.then(searchResponse.filter(movie => movie.media_type === "tv")));
            } 
        } catch (error) {
    ...
    console.log("MOVIES", searchMovieResults)
    console.log("TV", searchTvResult)
    return (
